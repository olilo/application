...
\cventry{03/2015 -- 05/2015}{Software Engineer}{}{\textsc{Ernsting.com}}{Berlin}{\begin{itemize}
\item Betreuung mehrerer Webseiten, die mit Subrion, einem PHP-basierten CMS, gebaut wurden
\end{itemize}}

\cventry{10/2013 -- 08/2014}{Software Engineer}{}{\textsc{Leanovate GmbH}}{Berlin}{\begin{itemize}
\item Betreuung einer Java- und AngularJS-basierten Applikation
\item HTML5/CSS2/CSS3 mit IE8-Anpassungen
\item strikt agiles Arbeiten in Scrum
\item Ausarbeitung und Halten von technischen Vorträgen
\end{itemize}}

\cventry{09/2010 -- 10/2013}{Senior Software Engineer}{}{\textsc{CosmoCode GmbH}}{Berlin}{\begin{itemize}
...
\cventry{08/2012 -- 07/2013}{Fachinformatiker für Anwendungsentwicklung}{Externe Ausbildung}{IHK}{Berlin}{\textit{Durchschnittsnote -- 75 von 100 Punkte}}
\cventry{10/2006 -- 09/2010}{\textit{8 Semester}}{Informatik}{Freie Universität}{Berlin}{}
...
\subsection{Immobilienscout - Immobilienbewertung}
\cvitem{Art}{Kundenprojekt}
\cvitem{Jahr}{2013-2014}
\cvitem{URL}{\url{http://www.immobilienscout24.de/realestatevaluation}}
\cvitem{Technologien}{\textsc{Javascript}, \textsc{HTML5}, \textsc{AngularJS}, \textsc{Spring}}
\cvitem{Beschreibung}{Unterprojekt der Webseite \url{http://www.immobilienscout24.de}, bei dem Vermieter den Wert einer Immobilie online bewerten lassen können.}
...
\cvitem{Beschreibung}{Palava ist ein modulares Application-Framework für Java-Backends. Der zentrale Bestandteil ist eine Interprocess-Communication-API, die es erlaubt einheitliche Endpoints zu entwickeln die dann mit unterschiedlichsten Transport-Technologien (z.B. \textsc{SOAP}, \textsc{REST}, \textsc{RMI}, \textsc{XML-RPC}, \textsc{JSON-RPC}, u.a.) genutzt werden können.}
...
\cvitem{Sprachen}{\textsc{Java}, \textsc{SQL}, \textsc{JavaScript}, \textsc{HTML}, \textsc{CSS}, \LaTeX, \textsc{Shell}}
\cvitem{Data Stores}{\textsc{MySQL}}
\cvitem{Libraries}{\textsc{AngularJS}, \textsc{jQuery}, \textsc{jQuery UI}}
\cvitem{Frameworks}{\textsc{Hibernate}, \textsc{JPA}, \textsc{Spring}}
...
\cvitem{Sprachen}{\textsc{PHP}, \textsc{Python}}
\cvitem{Data Stores}{\textsc{Solr}, \textsc{PostgreSQL}}
\cvitem{Libraries}{\textsc{Guava}, \textsc{SLF4J}}
\cvitem{Frameworks}{\textsc{Guice}, \textsc{Servlet API}, \textsc{CodeIgniter}, \textsc{Django}}
...
\cvitemwithcomment{Französisch}{Grundwissen}{}
