...
\cvitem{Beschreibung}{Ein Prototyp eines HTML5 Tower Defense Spiel, bei dem  Blumentürme auf Hexen schießen}
...
\cvitem{Team}{Tobias Sarnowski \& Florian Purchess}
\cvitem{Technologien}{\textsc{Java}, \textsc{JSF}, \textsc{JBoss 7}}
\cvitem{Beschreibung}{}
...
\cvitem{Frameworks}{\textsc{Guice}, \textsc{JPA}, \textsc{Servlet API}, \textsc{Django}, \textsc{CodeIgniter}}
